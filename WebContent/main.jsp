         ...
         <section class="section section-hero">
            ...
            <div class="container">
               <div class="statistics-box">
                  ...
                  <div class="statistics-item">
                     <span class="value">지역</span>
                     <p class="title">local</p>
                  </div>

                  <div class="statistics-item">
                     <span class="value">체크인</span>
                     <p class="title">Check-in</p>
                  </div>

                  <div class="statistics-item">
                     <span class="value">체크아웃</span>
                     <p class="title">Check-out</p>
                  </div>
                   <div class="statistics-item">
                     <span class="value">인원수</span>
                     <p class="title">Boats</p>
                  </div>
                   <div class="statistics-item">
                    <button type ="submit"><span class="value">검색</span></button>
                  </div>
               </div>
            </div>
         </section>
